...
<a id="des3" href="https://play.google.com/store/apps/details?id=com.youcam.chatpalestine&hl=ar" style="border-radius: 5px 0px 5px 0px;width:23%;margin:2px;" class="fl mini  fa  fa-
...
><font style="background-color: #fff;border-radius: 0px 25px 0px 25px;font-family: 'Cairo', sans-serif, FontAwesome;padding: 2px 10px 2px 10px; margin:0px 25px 0px 25px;" >Ø§Ù‡Ù„Ø¢ ÙˆØ³Ù‡Ù„Ø§Ù‹ Ø¨ÙƒÙ… ÙÙÙŠ Ø´Ø¢Øª Ø¬ÙˆØ§Ù„ ÙÙ„Ø³Ø·ÙŠÙ†  Ù„Ù„Ø¬ÙˆØ§Ù„   </font></div></div><center>`).insertBefore('#d2');$(`<img style="height:50px;width: 100%;margin-right: 5px;background-color: #DE9DA5;" src="https://www.chatjawwal.com/bnnr.jpeg" border="0">`).insertBefore('div#d2bc');$('.break.light').css({"background-image":"url(https://chatjawwal.com/bnr.jpg)"});(document.getElementById("tbox").placeholder=" Ù…Ù€Ø¢ ÙŠÙ„Ù€ÙØ¸ Ù…Ù† Ù‚Ù€ÙˆÙ„ Ø§Ù„Ø§ Ù„Ù€Ø¯ÙŠÙ‡ Ø±Ù‚Ù€ÙŠØ¨ Ø¹ØªÙŠÙ€Ø¯ ");$("div#tlogins button.btn.btn-primary").click(function(){var c=setInterval(function(){var a=$(".pmsgc").length;0<a?($(`<img style="height: 99.3%;
width:99%;
margin-top: 2px;
pointer-events:none;
 margin-bottom: 5px;
 "src="https://chatpalestine.me/s10.jpg"></div><center>`).appendTo("div#chats"),clearInterval(c)):console.log(a)},1)});$(`<button onfa-microphone="alert('Ù‚Ø±ÙŠØ¨Ø§')" style="width:31px;margin:2px;" style="margin-top:2px;margin-left:2px;" class="fa fa-video-camera fl btn btn-danger"></button>`).insertBefore('button.fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary');$('.nav-tabs').addClass('fl').css('width','100%'),$(`<button style="width:24px;margin:2px;" style="margin-top:2px;margin-left:2px;" class="fa fa-microphone fl btn btn-info"></button>`).insertBefore('button.fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary');$
