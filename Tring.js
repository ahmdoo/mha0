$(`<img src="https://www.chatjawwal.com/sico/z1eoioh9uv10.jpg" class="fr" style="width:100%;margin-top: 0px;">
    ...
    <div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      ...
      <div class="uzr fl" style="padding:0px;width:80%">
        <div style="padding:0px;width:100%;" class="fl">
          ...
          <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(199, 103, 48);" class="corner nosel u-topic dots fl hand">   - Ø´Ø§Øª Ø¬ÙˆØ§Ù„ ÙÙ„Ø³Ø·ÙŠÙ† â™️ª âœ˜   </span>
        </div>
        <br>
        <div style="padding: 0px; width: 100%; color: rgb(60, 0, 255);" class=" u-msg   break  fl">
        <div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: left;display: block;margin-top: -17px;" class=" u-msg   break  fl"> Ù…Ø±Ø­Ø¨Ø§Ù‹ Ø¨Ùƒ ðŸ‘‹ <h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1>    Ù†Ù‚Ø¯Ù‘Ø± ØªÙˆØ§Ø¬Ø¯Ùƒ Ù…Ø¹Ù†Ø§ØŒ ÙˆÙ†ØªÙ…Ù†Ù‰ Ù„Ùƒ ÙŠÙˆÙ…Ø§Ù‹ Ø³Ø¹ÙŠØ¯Ø§Ù‹ Ø¥Ù† Ø´Ø§Ø¡ Ø§Ù„Ù„Ù‡ ÙÙŠ Ø´Ø§Øª Ø¬ÙˆØ§Ù„ ÙÙ„Ø³Ø·ÙŠÙ†</div>
      </div>
    </div></div>
    `).appendTo('div#d2')
clearInterval(myVar);
...
$(`<center><div><div width="75.5%" style="background-color: #b7c3c5; color: #BF4A47;border-radius: 5px 5px 5px5px;border-bottom: 2px solid #ffffff;border-top: 2px solid#ffffff;padding-bottom: 2px!important;"  
><font style="background-color: #fff;border-radius: 0px 25px 0px 25px;font-family: 'Cairo', sans-serif, FontAwesome;padding: 2px 10px 2px 10px; margin:0px 25px 0px 25px;" >Ø§Ù‡Ù„Ø¢ ÙˆØ³Ù‡Ù„Ø§Ù‹ Ø¨ÙƒÙ… ÙÙÙŠ Ø´Ø¢Øª Ø¬ÙˆØ§Ù„ ÙÙ„Ø³Ø·ÙŠÙ†  Ù„Ù„Ø¬ÙˆØ§Ù„   </font></div></div><center>`).insertBefore('#d2');
$(`<img style="height:50px;width: 100%;margin-right: 5px;background-color: #DE9DA5;" src="https://www.chatjawwal.com/bnnr.jpeg" border="0">`).insertBefore('div#d2bc');
$('.break.light').css({"background-image":"url(#)"});
(document.getElementById("tbox").placeholder = " Ù…Ù€Ø¢ ÙŠÙ„Ù€ÙØ¸ Ù…Ù† Ù‚Ù€ÙˆÙ„ Ø§Ù„Ø§ Ù„Ù€Ø¯ÙŠÙ‡ Ø±Ù‚Ù€ÙŠØ¨ Ø¹ØªÙŠÙ€Ø¯ ");
...
pointer-events:none;
 margin-bottom: 5px;
 "src="#"></div><center>`).appendTo("div#chats"), clearInterval(c)) : console.log(a)
    }, 1)
});
$(`<button onfa-microphone="alert('Ù‚Ø±ÙŠØ¨Ø§')" style="width:31px;margin:2px;" style="margin-top:2px;margin-left:2px;" class="fa fa-video-camera fl btn btn-danger"></button>`).insertBefore('button.fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary');
$('.nav-tabs').addClass('fl').css('width','100%'),
...
$(` <center><div width="99%" id="asim7"><font style="background-color:#FFFFFF;color:#BF4A47;border-radius: 15px 15px 15px 15px;font-family: 'jazeera',FontAwesome;padding: 2px 10px 2px 10px;margin: 7px 10px 7px 10px;" > 
 (  Ø¯Ø±Ø¯Ø´Ø©️ Ø§Ù„Ø­Ø§Ø¦Ø· Ù…Ù…Ù†ÙˆØ¹Ù‡)  </font></div><center>`).insertBefore('div#d2bc');
...
Ù…ÙØ±Ø­Ø¨ Ø¨Ø§Ù„Ø¬Ù…ÙŠØ¹ Ù‡Ø°Ù‡ Ø³ÙŽÙ…Ø§Ø¡ Ø°Ø§ØªÙ Ø³ÙŽØ¹Ø©️ Ùˆ Ø§Ù…Ù’ØªÙØ¯Ø§Ø¯ ØŒÙˆ Ø£Ù†ØªÙ… Ù†Ø¬ÙˆÙ…Ù‡Ø§. Ù†Ø­Ù†  Ø§Ù„Ù…Ù…ÙŠØ²ÙˆÙ† ÙˆØ§Ù„Ø¨Ø§Ù‚ÙŠ Ø§Ù„Ù…Ù‚Ù„Ø¯ÙˆÙ†  )
</marquee></font></b></td>
`).insertBefore('span.s1.fa.fa-user.label.badgex.label-as-badge.label-success');
$(".fa-gear").text("Ø§Ù„Ø§Ø¹Ø¯Ø§Ø¯Ø§Øª").css("width","");
$(`<label onclick="window.open('cp?token='+token,'_blank');" style="background-color: ghostwhite;color: black;margin:4px; padding:8px;width:98%;" class="label tc border cp  btn  label-danger fl"><span class="fl fa fa-star"></span>Ø§Ø¯Ø§Ø±Ø©️ Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…ÙˆØ§Ù‚Ø¹</label>`).insertAfter('#settings label.label.tc.border.btn.fl[onclick="sendpic();"]');Tsend_=Tsend;reqlikes=200;Tsend=function(){if(getuser(myid).rep<reqlikes){alert(' Ù„Ø¥ ÙŠÙ…ÙƒÙ†Ùƒ Ø§Ù„ÙƒØªØ§Ø¨Ø©️ Ø¹Ø§Ù… ÙŠØªØ·Ù„Ø¨ Ù…Ù†Ùƒ Ø§Ù„Ø­ØµÙˆÙ„ Ø¹Ù„Ù‰ Ù„Ø§ÙŠÙƒØ§Øª'+reqlikes+' ');return;}else{Tsend_();}}
...
$("div#tlogins button.btn.btn-primary").click(function(){var b=setInterval(function(){var c=$(".pmsgc").length;0<c?($(`<a class="fl mini fa fa-bullhorn  btn btnn-default"></a><input type="jfa-w" name="FirstName" value="Ø§Ù„Ø¨Ø« Ø§Ù„Ù…Ø¨Ø§Ø´Ø± Ù‚Ø±ÙŠØ¨Ø§"><audio src="...." controls loop></audio><input type="jfa-w" name="FirstName" value="Ø³ÙˆØ±Ø©️ Ø§Ù„Ø­Ø¬Ø±"><audio src="https://chatpalestine.me/SaHeR2.mp3" controls loop></audio><input type="jfa-w" name="FirstName" value="Ø³ÙˆØ±Ø©️ Ø§Ù„Ù†Ù…Ù„"><audio src="https://chatpalestine.me/SaHeR1.mp3" controls loop></audio></div><center>`).appendTo("#settings"),clearInterval(b)):console.log(c)},1)});$
$("div#l3 button.btn.btn-primary").bind("click",function(){alert("Ø¹Ù†Ø¯ ØªØ³Ø¬ÙŠÙ„Ùƒ Ù„Ù„Ø¹Ø¶ÙˆÙŠØ©️
